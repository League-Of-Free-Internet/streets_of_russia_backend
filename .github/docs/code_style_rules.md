...
5. Стараться не добавлять закомментированный код в pull request'ы
...
9. В коде **"*.py"** используем двойные кавычки для строк **"строка"**, тройные двойные кавычки **""" Документ строка """**